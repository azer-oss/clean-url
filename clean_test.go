...
func TestCleanURL(t *testing.T) {
	...
	assert.Equal(t, "yolo.com/blog?span=eggs&reffoo=bar", cleanurl.Clean("http://www.yolo.com/blog/?span=eggs&utm_content=bufferc60dd&utm_medium=social&utm_source=twitter.com&utm_campaign=buffer&ref=asd&reffoo=bar"))
}
